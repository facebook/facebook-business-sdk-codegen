 ...
 public class ServerSideApiUtil {
   ...
   private static String validateCountry(String country) {
     ...
     if (!ISO_COUNTRY_LIST.contains(country.toUpperCase())) {
       throw new IllegalArgumentException("Invalid format for country:'" + country + "'.Please follow ISO 2-letter ISO 3166-1 standard for representing country. eg: us");
     }
   ...
   private static String validateCurrency(String currency) {
     ...
     if (!ISO_CURRENCY_LIST.contains(currency)) {
       throw new IllegalArgumentException("Invalid format for currency:'" + currency + "'.Please follow ISO 3-letter ISO 4217 standard for representing currency. Eg: usd");
     }
